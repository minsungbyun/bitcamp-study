...
public class ProjectHandler {
  ...
  public void update(MemberHandler memberHandler) {
    ...
    String owner = promptOwner(memberHandler, null);
    if (owner == null) {
      System.out.println("관리가자 없습니다.");
    }
  ...
  private String promptOwner(MemberHandler memberHandler, String name) {
  ...
  private String promptMembers(MemberHandler memberHandler, String oldMember) {
    String members = "";
    while (true) {
      String member = Prompt.inputString(String.format("팀원?(완료: 빈 문자열) "
